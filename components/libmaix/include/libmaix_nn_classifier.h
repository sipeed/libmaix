...
libmaix_err_t libmaix_classifier_add_sample_img(void* obj, libmaix_image_t* img);
...
libmaix_err_t libmaix_classifier_predict(void* obj, libmaix_image_t* img, float* min_distance);
