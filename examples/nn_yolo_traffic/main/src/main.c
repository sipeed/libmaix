...
void nn_test(struct libmaix_disp* disp)
{
    ...
    char* labels[] = {"Left", "Front", "Right", "Roundabout", "People", "Stop", "No entry", "No left turns", "Parking", "No right turns", "Trumpet", "Prohibited to go straight"};
    int class_num = 12;
    float anchors [10] =  {2.55, 3.38, 1.06, 1.15, 1.71, 2.25, 0.77, 0.74, 1.53, 1.93};
